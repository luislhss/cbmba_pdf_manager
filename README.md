...
Maneira mais breve, descompactar e acessar da pasta descompactada no endereço:
...\CBMBA – PDF MANEGER\cbmba_pdf_manager_DOWNLOAD_NATIVO_FINAL\cbmba_pdf_manager\src\static
Arquivo: index.html
Pode-se criar atalho para área de trabalho e adicionar icone.

📋 Instalação:
Extraia o arquivo cbmba_pdf_manager_final.zip
Abra o terminal/prompt na pasta extraída
Execute: pip install -r requirements.txt
Execute: python src/main.py
Acesse: http://localhost:5000
Na pasta abra o terminal/prompt
Abrindo terminal/prompt no Windows:
ara abrir o terminal (Prompt de Comando ou PowerShell) em uma pasta específica no Windows, você pode usar a barra de endereços do Explorador de Arquivos ou o menu de contexto. No menu de contexto, segure Shift e clique com o botão direito do mouse na pasta desejada para abrir o terminal na pasta atual. 
Opções para abrir o terminal na pasta desejada:
1.	1. Barra de endereços do Explorador de Arquivos:
•	Abra o Explorador de Arquivos e navegue até a pasta desejada. 
•	Na barra de endereços, digite "cmd" (para Prompt de Comando) ou "powershell" (para PowerShell) e pressione Enter. 
2.	2. Menu de contexto (Shift + botão direito do mouse):
•	Abra o Explorador de Arquivos e navegue até a pasta desejada. 
•	Segure a tecla Shift e clique com o botão direito do mouse em um espaço vazio dentro da pasta. 
•	No menu de contexto, escolha "Abrir janela de comando aqui" (para Prompt de Comando) ou "Abrir janela do PowerShell aqui" (para PowerShell). 

# Análise Final do Sistema CBMBA - Versão com Download Nativo do Navegador
